...
export function Scoreboard({ userTeam, opponentTeam, score, attempts, ticker, tickerStyle, tickerTeam = null, stageLabel, totalMarkerSlots = GAME.regulationPens, hideStageLabel = false, sharePreview = false, username = "", usernameEnabled = false }) {
  ...
  return (
    <section data-share-scoreboard="true" className={`relative mt-0 ${heightClass} shrink-0 overflow-visible bg-[#050505] mc-full-bleed-bg`} style={heightStyle}>
      <div data-share-scoreboard-main="true" className="relative overflow-hidden border-y border-[#F5F1E8]/18 bg-[#050505] shadow-[0_2px_8px_rgba(0,0,0,0.20)] mc-full-bleed-bg" style={{ height: `${100 - tickerPercent}%` }}>
        <div
      ...
      <div
        ...
        className="relative flex w-full items-center justify-center overflow-hidden px-[3%] text-center uppercase tracking-[0.085em] mc-full-bleed-bg"
        style={{
