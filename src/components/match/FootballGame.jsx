...
function Pitch({ ballPoint, keeperPoint, shot, shotActive, activeTeam, defenderTeam, showAim, aimDirection, assets }) {
  ...
  return (
    <section className="relative flex-1 shrink overflow-hidden bg-[#0d6c3d]">
      ...
      <div className="pointer-events-none absolute left-1/2 z-[3] h-[14%] w-[70%] -translate-x-1/2 rounded-b-full border-b-[8px] border-l-[8px] border-r-[8px] border-[#f5f1e8]" style={{ top: `${goalLine}%` }} />
