      ...
      <div className="flex h-[100dvh] flex-col overflow-hidden bg-[#F5F0E6]">
        ...
        <div className="min-h-0 flex-1">
          <FootballGame
            ...
            finishedActionLabel={matchResult && modalDismissed ? modalButton(matchResult) : "MATCH COMPLETE"}
            onFinishedAction={matchResult && modalDismissed ? onNextMatch : undefined}
          />
        </div>
