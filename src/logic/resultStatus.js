...
export const PITCH_BADGE_MODE = Object.freeze({
  MONDAY_CUP: "mondayCup",
  CHAMPION: PODIUM_BADGE_MODE.CHAMPION,
  RUNNER_UP: PODIUM_BADGE_MODE.RUNNER_UP,
  THIRD: PODIUM_BADGE_MODE.THIRD,
});
